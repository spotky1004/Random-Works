import GameOfLifeCanvas from "./GameOfLifeCanvas.js";
...
export default class Game {
    ...
    applyGame(rawCells, rawRule, rawStyle) {
        try {
            let cells = rawCells.replace(/ /g, "").slice(1, -1).split(")(").map(c => c.split(",").map(p => +p));
            let rules = {
                birth: [],
                survive: []
            };
    ...
    updateCanvas() {
        ...
        (_a = this.canvas.getContext("2d")) === null || _a === void 0 ? void 0 : _a.putImageData(imageData, 0, 0);
    }
}
